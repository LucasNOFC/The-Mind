...
Trata-se de uma aplicação de caráter **didático, conceitual e experimental**, voltada ao aprendizado e à reflexão.
...
- Processos mentais e subjetividade humana  

O conteúdo busca unir **pensamento crítico**, **observação social** e **expressão conceitual**, servindo tanto como espaço de estudo quanto de prática técnica.
...
- [XAMPP](https://www.apachefriends.org/pt_br/download.html) ou PHP configurado localmente  
