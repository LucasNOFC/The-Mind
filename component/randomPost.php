...
$randomPost = rand(0, count($topics) - 1);

$randomPost = $topics[$randomPost];

$tags = explode(",", $randomPost['tags']);
    ...
    <main id="post-container">
        <div id="post-topics">
            <div id="post-apresentation">
                ...
                <h3 id="post-description"><?= $randomPost['descriptiontext'] ?></h3>
            </div>
            <div id="post-image-container">
                <img id="post-img" src="data:image/jpeg;base64,<?= base64_encode($randomPost['imagePost']) ?>" alt="<?= $randomPost['descriptiontext'] ?>">
            </div>
